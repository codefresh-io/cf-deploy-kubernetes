...
RUN curl -o kubectl1.22 -L https://storage.googleapis.com/kubernetes-release/release/v1.22.0/bin/linux/${ARCH}/kubectl && \
...
COPY kubectl1.22 /usr/local/bin/
#COPY kubectl1.21 /usr/local/bin/
#COPY kubectl1.20 /usr/local/bin/
#COPY kubectl1.19 /usr/local/bin/
#COPY kubectl1.18 /usr/local/bin/
#COPY kubectl1.17 /usr/local/bin/
#COPY kubectl1.16 /usr/local/bin/
#COPY kubectl1.15 /usr/local/bin/
#COPY kubectl1.14 /usr/local/bin/
#COPY kubectl1.13 /usr/local/bin/
#COPY kubectl1.12 /usr/local/bin/
#COPY kubectl1.11 /usr/local/bin/
#COPY kubectl1.10 /usr/local/bin/kubectl
#COPY kubectl1.6 /usr/local/bin/
#
