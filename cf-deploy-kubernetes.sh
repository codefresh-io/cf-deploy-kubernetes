...
if (( "$SERVER_VERSION" <= "6" )); then mv -f '/usr/local/bin/kubectl1.6' '/usr/local/bin/kubectl' ; fi
if (( "$SERVER_VERSION" == "14" )); then mv -f '/usr/local/bin/kubectl1.14' '/usr/local/bin/kubectl' ; fi
if (( "$SERVER_VERSION" >= "15" )); then mv -f '/usr/local/bin/kubectl1.15' '/usr/local/bin/kubectl' ; fi
